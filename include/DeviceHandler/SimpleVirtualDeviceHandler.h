...
namespace usbipdcpp {
    ...
    protected:
        ...
        void request_set_descriptor(std::uint8_t desc_type, std::uint8_t desc_index, std::uint16_t language_id,
                                    std::uint16_t descriptor_length, const data_type &descriptor, std::uint32_t* p_status) override {
        }
        ...
        // data_type get_custom_descriptor(std::uint8_t type, std::uint8_t language_id,
