...
void SimpleHidInterfaceHandler::handle_non_hid_request_type_control_urb(std::uint32_t seqnum, const usbipdcpp::UsbEndpoint &ep,
...
usbipdcpp::data_type SimpleHidInterfaceHandler::request_get_report(std::uint8_t type, std::uint8_t report_id, std::uint16_t length,
                                                                   std::uint32_t *p_status) {
    *p_status = 0;
    return {0x00};
}

void SimpleHidInterfaceHandler::request_set_report(std::uint8_t type, std::uint8_t report_id, std::uint16_t length, const usbipdcpp::data_type &data,
                                                   std::uint32_t *p_status) {
    *p_status = 0;
}

usbipdcpp::data_type SimpleHidInterfaceHandler::request_get_idle(std::uint8_t type, std::uint8_t report_id, std::uint16_t length,
                                                                 std::uint32_t *p_status) {
    *p_status = 0;
    return {};
}
